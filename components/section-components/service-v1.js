    ...
    return <div className="ltn__service-area section-bg-1 pt-115 pb-70 go-top">
				...
				<div className="row  justify-content-center">
					...
					<div className="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
						...
						<h3><Link href="/service-details">Property Management</Link></h3>
					...
					<div className="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
						...
						<div className="ltn__feature-info">
						<h3><Link href="/service-details">Mortgage Service</Link></h3>
						<p>over 1 million+ homes for sale available on the website, we can match you with a house you will want to call home.</p>
						</div>
					</div>
					</div>
					...
					<div className="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
						...
						<div className="ltn__feature-info">
						<h3><Link href="/service-details">Consulting Service</Link></h3>
						<p>over 1 million+ homes for sale available on the website, we can match you with a house you will want to call home.</p>
						</div>
					</div>
					</div>
					...
					<div className="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
						...
						<div className="ltn__feature-info">
						<h3><Link href="/service-details">Home Buying</Link></h3>
						<p>over 1 million+ homes for sale available on the website, we can match you with a house you will want to call home.</p>
						</div>
					</div>
					</div>
					...
					<div className="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
						...
						<div className="ltn__feature-info">
						<h3><Link href="/service-details">Home Selling</Link></h3>
						<p>over 1 million+ homes for sale available on the website, we can match you with a house you will want to call home.</p>
						</div>
					</div>
					</div>
					...
					<div className="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
						...
						<div className="ltn__feature-info">
						<h3><Link href="/service-details">Escrow Services</Link></h3>
						<p>over 1 million+ homes for sale available on the website, we can match you with a house you will want to call home.</p>
						</div>
					</div>
					</div>
