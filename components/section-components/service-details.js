    ...
    return <div className="ltn__page-details-area ltn__service-details-area mb-105">
				...
				<div className="row">
					...
					<aside className="sidebar-area ltn__right-sidebar">
						...
						<ul className="go-top">
							<li><Link href="/service">Property Management <span><i className="fas fa-arrow-right" /></span></Link></li>
							<li className="active"><Link href="/service">Mortgage Service <span><i className="fas fa-arrow-right" /></span></Link></li>
							<li><Link href="/service">Consulting Service <span><i className="fas fa-arrow-right" /></span></Link></li>
							<li><Link href="/service">Home Buying <span><i className="fas fa-arrow-right" /></span></Link></li>
							<li><Link href="/service">Home Selling <span><i className="fas fa-arrow-right" /></span></Link></li>
							<li><Link href="/service">Escrow Services <span><i className="fas fa-arrow-right" /></span></Link></li>
						</ul>
						</div>
						{/* Newsletter Widget */}
