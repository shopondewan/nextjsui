    ...
    return <div className="ltn__page-details-area ltn__portfolio-details-area mb-105">
                ...
                <div className="row">
                    ...
                    <aside className="sidebar-area ltn__right-sidebar">
                        ...
                        <ul className="go-top">
                            <li><Link href="/portfolio">Property Management <span><i className="fas fa-arrow-right" /></span></Link></li>
                            <li className="active"><Link href="/portfolio">Mortgage Service <span><i className="fas fa-arrow-right" /></span></Link></li>
                            <li><Link href="/portfolio">Consulting Service <span><i className="fas fa-arrow-right" /></span></Link></li>
                            <li><Link href="/portfolio">Home Buying <span><i className="fas fa-arrow-right" /></span></Link></li>
                            <li><Link href="/portfolio">Home Selling <span><i className="fas fa-arrow-right" /></span></Link></li>
                            <li><Link href="/portfolio">Escrow Services <span><i className="fas fa-arrow-right" /></span></Link></li>
                        </ul>
                        </div>
                        {/* Newsletter Widget */}
                        ...
                        <Link href="/shop"><img src={publicUrl+"assets/img/banner/banner-2.jpg"} alt="Banner Image" /></Link>
                        </div>
                    </aside>
                    </div>
                </div>
