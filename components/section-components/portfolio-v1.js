				...
				<div className="container">
					...
					<div className="ltn__gallery-active row ltn__gallery-style-2 ltn__gallery-info-hide---">
						...
						<div className="ltn__gallery-item-inner">
							...
							<h4 className="go-top"><Link href="/portfolio-details">Portfolio Link </Link></h4>
						...
						<div className="ltn__gallery-item-inner">
							...
							<div className="ltn__gallery-item-info">
							<h4 className="go-top"><Link href="/portfolio-details">Inline Description </Link></h4>
							<p>Web Design &amp; Development, Branding</p>
							</div>
						</div>
						</div>
						...
						<div className="ltn__gallery-item-inner">
							...
							<div className="ltn__gallery-item-info">
							<h4 className="go-top"><Link href="/portfolio-details">Youtube Video </Link></h4>
							<p>Web Design &amp; Development, Branding</p>
							</div>
						</div>
						</div>
						...
						<div className="ltn__gallery-item-inner">
							...
							<div className="ltn__gallery-item-info">
							<h4 className="go-top"><Link href="/portfolio-details">Vimeo Video </Link></h4>
							<p>Web Design &amp; Development, Branding</p>
							</div>
						</div>
						</div>
						...
						<div className="ltn__gallery-item-inner">
							...
							<div className="ltn__gallery-item-info">
							<h4 className="go-top"><Link href="/portfolio-details">HTML5 Video </Link></h4>
							<p>Web Design &amp; Development, Branding</p>
							</div>
						</div>
						</div>
						...
						<div className="ltn__gallery-item-inner">
							...
							<div className="ltn__gallery-item-info">
							<h4 className="go-top"><Link href="/portfolio-details">Google Map </Link></h4>
							<p>Web Design &amp; Development, Branding</p>
							</div>
						</div>
						</div>
						...
						<div className="ltn__gallery-item-inner">
							...
							<div className="ltn__gallery-item-info">
							<h4 className="go-top"><Link href="/portfolio-details">Image Caption </Link></h4>
							<p>Web Design &amp; Development, Branding</p>
							</div>
						</div>
						</div>
						...
						<div className="ltn__gallery-item-inner">
							...
							<div className="ltn__gallery-item-info">
							<h4 className="go-top"><Link href="/portfolio-details">Not Found</Link></h4>
							<p>Web Design &amp; Development, Branding</p>
							</div>
						</div>
						</div>
					...
					<div className="btn-wrapper text-center">
						<Link href="#" className="btn btn-transparent btn-effect-3 btn-border">LOAD MORE +</Link>
					</div>
					</div>
			</div>
        }
