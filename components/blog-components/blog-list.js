			...
			<div className="row">
				...
				<div className="ltn__blog-list-wrap">
					...
					<div className="ltn__blog-img">
						<Link href="/blog-details"><img src={publicUrl+"assets/img/blog/31.jpg"} alt="Image" /></Link>
					</div>
					<div className="ltn__blog-brief">
						...
						<div className="ltn__blog-meta">
							...
							<li className="ltn__blog-author">
								<Link href="/blog-grid"><img src={publicUrl+"assets/img/blog/author.jpg"} alt="#" />By: Ethan</Link>
							</li>
							</ul>
						</div>
					...
					<div className="ltn__blog-gallery-active slick-arrow-1 slick-arrow-1-inner">
						...
						<Link href="/blog-details"><img src={publicUrl+"assets/img/blog/33.jpg"} alt="Image" /></Link>
						</div>
						<div className="ltn__blog-gallery-item">
						<Link href="/blog-details"><img src={publicUrl+"assets/img/blog/34.jpg"} alt="Image" /></Link>
						</div>
						<div className="ltn__blog-gallery-item">
						<Link href="/blog-details"><img src={publicUrl+"assets/img/blog/31.jpg"} alt="Image" /></Link>
						</div>
