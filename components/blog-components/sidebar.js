			...
			<aside className="sidebar-area blog-sidebar ltn__right-sidebar">
				...
				<ul>
					...
					<div className="top-rated-product-item clearfix go-top">
						...
						<h6><Link href="/product-details">Luxury House In Greenville </Link></h6>
					...
					<div className="top-rated-product-item clearfix">
						...
						<h6><Link href="/product-details">Apartment with Subunits</Link></h6>
						<div className="product-price">
							<span>$30,000.00</span>
							<del>$35,000.00</del>
						</div>
					...
					<div className="top-rated-product-item clearfix">
						...
						<h6><Link href="/product-details">3 Rooms Manhattan</Link></h6>
						<div className="product-price">
							<span>$30,000.00</span>
							<del>$35,000.00</del>
						</div>
				...
				<div className="row ltn__popular-product-widget-active slick-arrow-1">
					...
					<div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
						...
						<h2 className="product-title"><Link href="/product-details">New Apartment Nice View</Link></h2>
						<div className="product-img-location">
							<ul>
							<li>
								<Link href="/product-details"><i className="flaticon-pin" /> Belmont Gardens, Chicago</Link>
							</li>
							</ul>
						</div>
					...
					<div className="popular-post-widget-item clearfix">
						...
						<div className="ltn__blog-meta">
							...
							<li className="ltn__blog-date">
								<Link href="#"><i className="far fa-calendar-alt" />June 22, 2020</Link>
							</li>
							</ul>
						</div>
						</div>
