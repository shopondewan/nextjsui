				...
				<div className="ltn__blog-details-wrap">
					...
					<div className="ltn__blog-meta">
						...
						<li className="ltn__blog-author go-top">
							<Link href="/team-details"><img src={publicUrl+"assets/img/blog/author.jpg"} alt="#" />By: Ethan</Link>
						</li>
					...
					<div className="row">
						...
						<div className="ltn__blog-item ltn__blog-item-6">
							...
							<Link href="/blog-details"><img src={publicUrl+"assets/img/blog/blog-details/11.jpg"} alt="Image" /></Link>
							</div>
						...
						<div className="ltn__blog-item ltn__blog-item-6">
							<div className="ltn__blog-img">
							<Link href="/blog-details"><img src={publicUrl+"assets/img/blog/blog-details/12.jpg"} alt="Image" /></Link>
							</div>
							<div className="ltn__blog-brief">
							<div className="ltn__blog-meta">
								<ul>
