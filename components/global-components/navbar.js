					...
					<div className="header-menu d-none d-xl-block">
						...
						<div className="ltn__main-menu go-top">
							...
							<li className="menu-icon"><Link href="/">Home</Link>
								...
								<li>
									<Link href="/home-v5">Home Style 05 <span className="menu-item-badge">video</span></Link>
							...
							<li className="menu-icon"><Link href="#">Pages</Link>
			...
			<div id="ltn__utilize-mobile-menu" className="ltn__utilize ltn__utilize-mobile-menu">
				<div className="ltn__utilize-menu-inner ltn__scrollbar">
					...
					<ul>
						...
						<li><Link href="/home-v5">Home Style 05 <span className="menu-item-badge">video</span></Link></li>
				...
				<div className="mini-cart-product-area ltn__scrollbar">
					...
					<div className="mini-cart-img go-top">
						<Link href="/product-details"><img src={publicUrl+"assets/img/product/1.png"} alt="Image" /></Link>
					...
					<div className="mini-cart-item clearfix">
					<div className="mini-cart-img go-top">
						<Link href="/product-details"><img src={publicUrl+"assets/img/product/2.png"} alt="Image" /></Link>
						<span className="mini-cart-item-delete"><i className="icon-cancel" /></span>
					</div>
					<div className="mini-cart-info go-top">
					...
					<div className="mini-cart-item clearfix">
					<div className="mini-cart-img go-top">
						<Link href="/product-details"><img src={publicUrl+"assets/img/product/3.png"} alt="Image" /></Link>
						<span className="mini-cart-item-delete"><i className="icon-cancel" /></span>
					</div>
					<div className="mini-cart-info go-top">
					...
					<div className="mini-cart-item clearfix">
					<div className="mini-cart-img go-top">
						<Link href="/product-details"><img src={publicUrl+"assets/img/product/4.png"} alt="Image" /></Link>
						<span className="mini-cart-item-delete"><i className="icon-cancel" /></span>
					</div>
					<div className="mini-cart-info go-top">
