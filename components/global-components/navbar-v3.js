			              ...
			              <ul>
			                <li>
			                  ...
			                  <div className="ltn__drop-menu ltn__currency-menu ltn__language-menu">
			                    <ul>
			                      <li><Link href="#" className="dropdown-toggle"><span className="active-currency">English</span></Link>
			                        <ul>
			        ...
			        <div className="col">
			          <div className="site-logo-wrap">
			            <div className="site-logo go-top">
			              <Link href="/"><img src={publicUrl+"assets/img/logo-2.png"} alt="Logo" /></Link>
			            </div>
