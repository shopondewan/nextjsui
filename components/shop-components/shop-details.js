						...
						<div className="ltn__shop-details-inner ltn__page-details-inner mb-60">
							<div className="ltn__blog-meta">
								<ul>
									...
									<li>
										<Link href="#"><a><i className="far fa-comments" />35 Comments</a></Link>
									</li>
								</ul>
							</div>
							...
							<div className="row">
								...
								<div className="col-xl-6 col-sm-6 col-12 go-top">
									<div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
										<div className="product-img">
											<Link href="/shop"><a><img src={publicUrl + "assets/img/product-3/1.jpg"} alt="#" /></a></Link>
											<div className="real-estate-agent">
												<div className="agent-img">
													<Link href="/team-details"><a><img src={publicUrl + "assets/img/blog/author.jpg"} alt="#" /></a></Link>
												</div>
											</div>
										</div>
										<div className="product-info">
											...
											<div className="product-img-location">
												<ul>
													<li>
														<Link href="/shop"><a><i className="flaticon-pin" /> Belmont Gardens, Chicago</a></Link>
													</li>
												</ul>
											</div>
								...
								<div className="col-xl-6 col-sm-6 col-12 go-top">
									<div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
										<div className="product-img">
											<Link href="/shop"><a><img src={publicUrl + "assets/img/product-3/2.jpg"} alt="#" /></a></Link>
											<div className="real-estate-agent">
												<div className="agent-img">
													<Link href="/team-details"><a><img src={publicUrl + "assets/img/blog/author.jpg"} alt="#" /></a></Link>
												</div>
					...
					<div className="col-lg-4">
						<aside className="sidebar ltn__shop-sidebar ltn__right-sidebar---">
							...
							<div className="widget ltn__top-rated-product-widget go-top">
								...
								<ul>
									<li>
										<div className="top-rated-product-item clearfix">
											<div className="top-rated-product-img">
												<Link href="/product-details"><a><img src={publicUrl + "assets/img/product/1.png"} alt="#" /></a></Link>
											</div>
									...
									<li>
										<div className="top-rated-product-item clearfix">
											<div className="top-rated-product-img">
												<Link href="/product-details"><a><img src={publicUrl + "assets/img/product/2.png"} alt="#" /></a></Link>
											</div>
											<div className="top-rated-product-info">
												<div className="product-ratting">
													<ul>
									...
									<li>
										<div className="top-rated-product-item clearfix">
											<div className="top-rated-product-img">
												<Link href="/product-details"><a><img src={publicUrl + "assets/img/product/3.png"} alt="#" /></a></Link>
											</div>
											<div className="top-rated-product-info">
												<div className="product-ratting">
													<ul>
							...
							<div className="widget ltn__menu-widget ltn__menu-widget-2--- ltn__menu-widget-2-color-2---">
								...
								<ul className="go-top">
									<li><Link href="/blog-grid"><a>Apartments <span>(26)</span></a></Link></li>
									<li><Link href="/blog-grid"><a>Picture Stodio <span>(30)</span></a></Link></li>
									<li><Link href="/blog-grid"><a>Office  <span>(71)</span></a></Link></li>
									<li><Link href="/blog-grid"><a>Luxary Vilas <span>(56)</span></a></Link></li>
									<li><Link href="/blog-grid"><a>Duplex House <span>(60)</span></a></Link></li>
								</ul>
							</div>
							...
							<div className="widget ltn__popular-product-widget">
								...
								<div className="row ltn__popular-product-widget-active slick-arrow-1">
									...
									<div className="col-12">
										<div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
											<div className="product-img go-top">
												<Link href="/shop"><a><img src={publicUrl + "assets/img/product-3/6.jpg"} alt="#" /></a></Link>
												<div className="real-estate-agent">
													<div className="agent-img">
														<Link href="/team-details"><a><img src={publicUrl + "assets/img/blog/author.jpg"} alt="#" /></a></Link>
													</div>
									...
									<div className="col-12">
										<div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
											<div className="product-img">
												<a href="product-details.html"><a><img src={publicUrl + "assets/img/product-3/4.jpg"} alt="#" /></a></a>
												<div className="real-estate-agent">
													<div className="agent-img">
														<Link href="/team-details"><a><img src={publicUrl + "assets/img/blog/author.jpg"} alt="#" /></a></Link>
													</div>
									...
									<div className="col-12">
										<div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
											<div className="product-img">
												<a href="product-details.html"><a><img src={publicUrl + "assets/img/product-3/5.jpg"} alt="#" /></a></a>
												<div className="real-estate-agent">
													<div className="agent-img">
														<Link href="/team-details"><a><img src={publicUrl + "assets/img/blog/author.jpg"} alt="#" /></a></Link>
													</div>
							...
							<div className="widget ltn__popular-post-widget go-top">
								...
								<ul>
									<li>
										<div className="popular-post-widget-item clearfix">
											<div className="popular-post-widget-img">
												<Link href="/blog-details"><a><img src={publicUrl + "assets/img/team/5.jpg"} alt="#" /></a></Link>
											</div>
									...
									<li>
										<div className="popular-post-widget-item clearfix">
											<div className="popular-post-widget-img">
												<Link href="/blog-details"><a><img src={publicUrl + "assets/img/team/6.jpg"} alt="#" /></a></Link>
											</div>
											<div className="popular-post-widget-brief">
												<h6><Link href="/blog-details">Lorem ipsum dolor sit
													cing elit, sed do.</Link></h6>
									...
									<li>
										<div className="popular-post-widget-item clearfix">
											<div className="popular-post-widget-img">
												<Link href="/blog-details"><a><img src={publicUrl + "assets/img/team/7.jpg"} alt="#" /></a></Link>
											</div>
											<div className="popular-post-widget-brief">
												<h6><Link href="/blog-details">Lorem ipsum dolor sit
													cing elit, sed do.</Link></h6>
									...
									<li>
										<div className="popular-post-widget-item clearfix">
											<div className="popular-post-widget-img">
												<Link href="/blog-details"><a><img src={publicUrl + "assets/img/team/8.jpg"} alt="#" /></a></Link>
											</div>
											<div className="popular-post-widget-brief">
												<h6><Link href="/blog-details">
							...
							<div className="widget ltn__banner-widget d-none go-top">
								<Link href="/shop"><a><img src={publicUrl + "assets/img/banner/2.jpg"} alt="#" /></a></Link>
							</div>
						</aside>
					</div>
				</div>
